...
class Rectangle:
    ...
    def __eq__(self, other):
        ...
        if self.width == other.width and \
           self.height == other.height and self.unit == other.unit:
            return True
        else:
            return False
    ...
    def larger_than(self, other):
        """ returns True if the called Rectangle object (the object given by 
            self) has a larger area than the area of the Rectangle passed in 
            for other, and False otherwise
        """
