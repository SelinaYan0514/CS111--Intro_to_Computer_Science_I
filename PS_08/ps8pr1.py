...
# function 3
    def advance_one(self):
        ...
        """
        if self.month == 12 and self.day == self.days_in_month():
            self.month = 1
            self.day = 1  
            self.year += 1 
            
        elif self.day == self.days_in_month():
            self.month += 1
            self.day = 1 
...
#function 6
    def is_before(self, other):
        """ returns True if the called object represents a calendar date that 
            ...
            self and other represent the same day, or if self occurs after other, 
...
#function 7
    def is_after(self, other):
        """ returns True if the calling object represents a calendar date that 
            ...
            and other represent the same day, or if self occurs before other, 
            the method should return False.
        """
        if self.year > other.year:
            return True
...
#function 8
    def days_between(self, other):
        ...
        if self_copy == other_copy:
            return 0
        elif self_copy.is_before(other_copy):
            count = 0
